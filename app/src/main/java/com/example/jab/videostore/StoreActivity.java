...
public class StoreActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView text_greeting_user = (TextView) navigationView.findViewById(R.id.text_greeting_user);
        //final TextView text_username = (TextView) findViewById(R.id.text_greeting_user);
